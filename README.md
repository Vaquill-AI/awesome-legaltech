...
- [Moonlit Legal Research MCP](https://www.moonlit.ai/docs/mcp/connect) - **[🇪🇺 Europe]** Remote MCP server over European primary law, expanding globally: 20M+ documents from 130+ official portals across 35+ jurisdictions, with article-level reference search across a 100M+ citation graph. Every result returns the publisher's source URL; ISO 27001 certified, OAuth sign-in, free tier, and MIT-licensed [skills](https://github.com/moonlit-ai/moonlit-skills).
