...
- [Legalise](https://github.com/b1rdmania/legalise) - **[Open Source]** Independent register for AI-assisted legal work in England & Wales: records human review, edit, approval, and sign-off outside the tool that did the drafting. BYOK, hosted at [legalise.dev](https://legalise.dev) as an evaluation release.
