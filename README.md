...
- [intake-triage-mcp](https://github.com/granolacowboy/intake-triage-mcp) - **[Open Source]** **[Apache-2.0]** Deterministic legal intake triage: practice-area lookup, a deterministic fuzzy conflict-screening gate, matter validation, provenance, and an eval harness — no LLM or network calls in the decision path. Self-hostable (stdio).
