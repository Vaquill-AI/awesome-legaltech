...
- [mcp-italian-workplace-safety](https://github.com/tutor-sicurezza/mcp-italian-workplace-safety) - **[🇮🇹 Italy]** **[Open Source]** **[MIT]** MCP server exposing Italian workplace-safety regulation (D.Lgs 81/08): ATECO risk classification, training schedules from Accordo Stato-Regioni, glossary of 218 legal terms, sanctions, and Testo Unico articles. Works with Claude Desktop, Cursor, Cline, Windsurf.
