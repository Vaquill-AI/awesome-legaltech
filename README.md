...
- [SafeLegalAI datasets](https://huggingface.co/safelegalaidata) - **[🌍 Multi]** - **[13 tables]** - AI in legal practice as CC BY 4.0 data: court decisions sanctioning AI misuse (150), US court decisions on generative AI (567, public-domain passages), AI-evidence rulings (60), a 130-country regulatory map with 515 versioned official documents, the EU AI Act as structured data, US court AI orders (222) and bills (41), justice-sector AI deployments (595), vendor documentation facts; every row links its primary source. Pipelines on [GitHub](https://github.com/SafeLegalAI).
