...
- [LibreJustice](https://github.com/librejustice/librejustice) - **[🇫🇷 France]** Remote MCP server (streamable HTTP, OAuth 2.1) over French case law from both court orders (Conseil d'État, Cour de cassation, cours d'appel, tribunaux judiciaires and administratifs, CNDA, Conseil constitutionnel) and French legal texts as they read on any past date (codes, lois, décrets, treaties, collective agreements), plus CJEU and ECHR case law. Also served as a web UI and a REST API. Apache-2.0.
